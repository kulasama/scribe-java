 ...
 */
public class NsfocusServiceImpl implements OAuthService
{
   ...
   */
  public NsfocusServiceImpl(DefaultApi10a api, OAuthConfig config)
  {
    this.api = api;
    this.config = config;
    this.scope = NO_SCOPE;
  ...
  {
	//String verb = api.getRequestTokenVerb();
	//String endpoint = api.getRequestTokenEndpoint();
